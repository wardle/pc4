    ...
    (cond
      ...
      (ui/ui-vertical-navigation2
        ...
        [{:id      :home
         ...
         {:id      :neuroinflammatory
          :sub     true
          :hidden  (not show-ninflamm?)
          :content "Neuroinflammatory"
  ...
  (when (and id patient_identifier)
    (comp/fragment
     ...
     (if (permissions :PATIENT_VIEW)
       (div :.flex.flex-col.md:flex-row.gap-x-4.relative.pr-2
            (div :.w-full.md:w-64.md:shrink-0.p-2
