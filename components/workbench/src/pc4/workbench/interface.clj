(ns pc4.workbench.interface
  (:require
    ...
    [pc4.workbench.controllers.patient.episodes :as patient-episodes]
    ...
    [pc4.workbench.controllers.patient.research :as patient-research]
    [pc4.workbench.controllers.patient.admissions :as patient-admissions]
...
(defn routes [{:keys [odsui snomedui]}]
  (set/union
    #{["/" :get [login/authenticated project/update-session home/home-page] :route-name :home]
      ...
      ["/patient/:patient-identifier/research" :get [login/authenticated patient/authorized patient-research/research-handler] :route-name :patient/research]
      ["/patient/:patient-identifier/episode/:episode-id/modal" :get [login/authenticated patient/authorized patient-episodes/episode-modal-handler] :route-name :patient/episode-modal]
      ["/patient/:patient-identifier/episode/:episode-id/discharge" :post [login/authenticated patient/authorized patient-episodes/episode-discharge-handler] :route-name :patient/episode-discharge]
